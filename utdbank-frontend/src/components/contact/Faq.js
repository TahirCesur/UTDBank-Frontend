                ...
                <div className="faq-accordion">
                  <div className="faq-accordion-item faq-accordion-item-active">
                    <div className="faq-accordion-header">
                      <h3 className="faq-accordion-title">How can I cancel/pause my subscription?</h3>
                    ...
                    <div className="faq-accordion-body">
                      <div className="faq-accordion-body-inner">
                        <p className="faq-accordion-para">
                          ...
                          labore et dolore magna aliqua. Ut enim ad minim veniaquis nostrud ullamco nisi ut aliquip
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="faq-accordion-item">
                    <div className="faq-accordion-header">
                      <h3 className="faq-accordion-title">Does the price go up as my team gets larger?</h3>
                      <div className="faq-accordion-header-overlay"></div>
                    </div>
                    <div className="faq-accordion-body">
                      <div className="faq-accordion-body-inner">
                  ...
                  <div className="faq-accordion-item">
                    <div className="faq-accordion-header">
                      <h3 className="faq-accordion-title">What access do I have on a free trial?</h3>
                      <div className="faq-accordion-header-overlay"></div>
                    </div>
                    <div className="faq-accordion-body">
                      <div className="faq-accordion-body-inner">
                  ...
                  <div className="faq-accordion-item">
                    <div className="faq-accordion-header">
                      <h3 className="faq-accordion-title">What access do I have on the free plan?</h3>
                      <div className="faq-accordion-header-overlay"></div>
                    </div>
                    <div className="faq-accordion-body">
                      <div className="faq-accordion-body-inner">
