            ...
            <div className="col-sm-12 col-md-12 col-lg-6 order-2 order-lg-1">
              <div className="home-about-item desk-pad-right-10 pb-30">
                ...
                <SectionTitle
                  ...
                  content="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod cste et dolore magnam aliquam quaerat voluptatem."
                />
            ...
            <div className="col-sm-12 col-md-12 col-lg-6 order-1 order-lg-2">
              <div className="home-about-item home-about-image pb-30 about-image-ellipsis">
                <div className="home-image-content">
                  <img src="/assets/images/enterprise.png" alt="about" className="scale-one-zero-one" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row align-items-center">
            <div className="col-sm-12 col-md-12 col-lg-6">
              <div className="home-about-item home-about-image pb-30 about-image-shape">
                <div className="home-image-content">
                  <img src="/assets/images/business.png" alt="about" className="scale-one-zero-one" />
                </div>
              </div>
            </div>
            <div className="col-sm-12 col-md-12 col-lg-6">
              <div className="home-about-item desk-pad-left-10 pb-30">
                ...
                <SectionTitle
                  ...
                  content="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod cste et dolore magnam aliquam quae voluptatem."
                />
          ...
          <div className="row align-items-center">
            ...
            <div className="col-sm-12 col-md-12 col-lg-6 order-1 order-lg-2">
              <div className="home-about-item home-about-image about-image-rectangle pb-30">
                <div className="home-image-content">
                  <img src="/assets/images/entrepreneur.png" alt="about" className="scale-one-zero-one" />
                </div>
              </div>
            </div>
          </div>
